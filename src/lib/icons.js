...
const ICON_PATHS = {
  ...
  cursor: `<path ${pathAttrs} d="m3 3 7.6 18 2.3-7.1L20 11.6 3 3Z"/><path ${pathAttrs} d="m13 13 6 6"/>`,
  move: `<path ${pathAttrs} d="M12 2v20"/><path ${pathAttrs} d="m15 5-3-3-3 3"/><path ${pathAttrs} d="m15 19-3 3-3-3"/><path ${pathAttrs} d="M2 12h20"/><path ${pathAttrs} d="m5 9-3 3 3 3"/><path ${pathAttrs} d="m19 9 3 3-3 3"/>`,
  undo: `<path ${pathAttrs} d="M9 14 4 9l5-5"/><path ${pathAttrs} d="M4 9h10a6 6 0 0 1 0 12h-1"/>`,
  redo: `<path ${pathAttrs} d="m15 14 5-5-5-5"/><path ${pathAttrs} d="M20 9H10a6 6 0 0 0 0 12h1"/>`,
  eye: `<path ${pathAttrs} d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle ${pathAttrs} cx="12" cy="12" r="3"/>`,
  ...
  check: `<path ${pathAttrs} d="M20 6 9 17l-5-5"/>`,
  x: `<path ${pathAttrs} d="M18 6 6 18"/><path ${pathAttrs} d="m6 6 12 12"/>`,
  alertTriangle: `<path ${pathAttrs} d="m21.7 18-8-14a2 2 0 0 0-3.4 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.7-3Z"/><path ${pathAttrs} d="M12 9v4"/><path ${pathAttrs} d="M12 17h.01"/>`,
  ban: `<circle ${pathAttrs} cx="12" cy="12" r="10"/><path ${pathAttrs} d="m4.9 4.9 14.2 14.2"/>`,
