...
- [**Queries**](#queries)
  ...
  - [*GetDescuentoByCodigo*](#getdescuentobycodigo)
  - [*ListDescuentosAdmin*](#listdescuentosadmin)
...
- [**Mutations**](#mutations)
  ...
  - [*DeleteConfiguracion*](#deleteconfiguracion)
  - [*DeletePaquete*](#deletepaquete)
  - [*DeleteMovimientoInventario*](#deletemovimientoinventario)
  - [*DeleteLandingPage*](#deletelandingpage)
  - [*DeleteDescuento*](#deletedescuento)
  - [*DeleteTicket*](#deleteticket)
  - [*DeleteMesaReserva*](#deletemesareserva)
  - [*UpsertConfiguracion*](#upsertconfiguracion)
  - [*CreateDescuento*](#createdescuento)
  - [*UpdateDescuento*](#updatedescuento)
  - [*ConsumeDescuento*](#consumedescuento)
...
## GetConfiguracion
You can execute the `GetConfiguracion` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
getConfiguracion(vars: GetConfiguracionVariables, options?: ExecuteQueryOptions): QueryPromise<GetConfiguracionData, GetConfiguracionVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getConfiguracion(dc: DataConnect, vars: GetConfiguracionVariables, options?: ExecuteQueryOptions): QueryPromise<GetConfiguracionData, GetConfiguracionVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the getConfiguracionRef:
```typescript
const name = getConfiguracionRef.operationName;
console.log(name);
```

### Variables
The `GetConfiguracion` query requires an argument of type `GetConfiguracionVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `GetConfiguracion` query returns a `QueryPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `GetConfiguracionData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```
### Using `GetConfiguracion`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getConfiguracion, GetConfiguracionVariables } from '@dataconnect/generated';

// The `GetConfiguracion` query requires an argument of type `GetConfiguracionVariables`:
const getConfiguracionVars: GetConfiguracionVariables = {
  id: ..., 
};

// Call the `getConfiguracion()` function to execute the query.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await getConfiguracion(getConfiguracionVars);
// Variables can be defined inline as well.
const { data } = await getConfiguracion({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await getConfiguracion(dataConnect, getConfiguracionVars);

console.log(data.configuracion);

// Or, you can use the `Promise` API.
getConfiguracion(getConfiguracionVars).then((response) => {
  const data = response.data;
  console.log(data.configuracion);
});
```

### Using `GetConfiguracion`'s `QueryRef` function

```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getConfiguracionRef, GetConfiguracionVariables } from '@dataconnect/generated';
...
// Call the `getConfiguracionRef()` function to get a reference to the query.
const ref = getConfiguracionRef(getConfiguracionVars);
// Variables can be defined inline as well.
const ref = getConfiguracionRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = getConfiguracionRef(dataConnect, getConfiguracionVars);
...
You can execute the `GetDescuentoByCodigo` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
getDescuentoByCodigo(vars: GetDescuentoByCodigoVariables, options?: ExecuteQueryOptions): QueryPromise<GetDescuentoByCodigoData, GetDescuentoByCodigoVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getDescuentoByCodigo(dc: DataConnect, vars: GetDescuentoByCodigoVariables, options?: ExecuteQueryOptions): QueryPromise<GetDescuentoByCodigoData, GetDescuentoByCodigoVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the getDescuentoByCodigoRef:
```typescript
const name = getDescuentoByCodigoRef.operationName;
console.log(name);
```

### Variables
The `GetDescuentoByCodigo` query requires an argument of type `GetDescuentoByCodigoVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `GetDescuentoByCodigo` query returns a `QueryPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `GetDescuentoByCodigoData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```
### Using `GetDescuentoByCodigo`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getDescuentoByCodigo, GetDescuentoByCodigoVariables } from '@dataconnect/generated';

// The `GetDescuentoByCodigo` query requires an argument of type `GetDescuentoByCodigoVariables`:
const getDescuentoByCodigoVars: GetDescuentoByCodigoVariables = {
  codigo: ..., 
};

// Call the `getDescuentoByCodigo()` function to execute the query.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await getDescuentoByCodigo(getDescuentoByCodigoVars);
// Variables can be defined inline as well.
const { data } = await getDescuentoByCodigo({ codigo: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await getDescuentoByCodigo(dataConnect, getDescuentoByCodigoVars);

console.log(data.descuentos);

// Or, you can use the `Promise` API.
getDescuentoByCodigo(getDescuentoByCodigoVars).then((response) => {
  const data = response.data;
  console.log(data.descuentos);
});
```

### Using `GetDescuentoByCodigo`'s `QueryRef` function

```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getDescuentoByCodigoRef, GetDescuentoByCodigoVariables } from '@dataconnect/generated';
...
// Call the `getDescuentoByCodigoRef()` function to get a reference to the query.
const ref = getDescuentoByCodigoRef(getDescuentoByCodigoVars);
// Variables can be defined inline as well.
const ref = getDescuentoByCodigoRef({ codigo: ..., });

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = getDescuentoByCodigoRef(dataConnect, getDescuentoByCodigoVars);
...
## ListDescuentosAdmin
You can execute the `ListDescuentosAdmin` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
listDescuentosAdmin(options?: ExecuteQueryOptions): QueryPromise<ListDescuentosAdminData, undefined>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
listDescuentosAdmin(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<ListDescuentosAdminData, undefined>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the listDescuentosAdminRef:
```typescript
const name = listDescuentosAdminRef.operationName;
console.log(name);
```

### Variables
The `ListDescuentosAdmin` query has no variables.
### Return Type
Recall that executing the `ListDescuentosAdmin` query returns a `QueryPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `ListDescuentosAdminData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```
### Using `ListDescuentosAdmin`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listDescuentosAdmin } from '@dataconnect/generated';


// Call the `listDescuentosAdmin()` function to execute the query.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await listDescuentosAdmin();

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await listDescuentosAdmin(dataConnect);

console.log(data.descuentos);

// Or, you can use the `Promise` API.
listDescuentosAdmin().then((response) => {
  const data = response.data;
  console.log(data.descuentos);
});
```

### Using `ListDescuentosAdmin`'s `QueryRef` function

```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, listDescuentosAdminRef } from '@dataconnect/generated';


// Call the `listDescuentosAdminRef()` function to get a reference to the query.
const ref = listDescuentosAdminRef();

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = listDescuentosAdminRef(dataConnect);
...
## DeleteUserRecord
You can execute the `DeleteUserRecord` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
deleteUserRecord(vars: DeleteUserRecordVariables): MutationPromise<DeleteUserRecordData, DeleteUserRecordVariables>;

interface DeleteUserRecordRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: DeleteUserRecordVariables): MutationRef<DeleteUserRecordData, DeleteUserRecordVariables>;
}
export const deleteUserRecordRef: DeleteUserRecordRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
deleteUserRecord(dc: DataConnect, vars: DeleteUserRecordVariables): MutationPromise<DeleteUserRecordData, DeleteUserRecordVariables>;

interface DeleteUserRecordRef {
  ...
  (dc: DataConnect, vars: DeleteUserRecordVariables): MutationRef<DeleteUserRecordData, DeleteUserRecordVariables>;
}
export const deleteUserRecordRef: DeleteUserRecordRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the deleteUserRecordRef:
```typescript
const name = deleteUserRecordRef.operationName;
console.log(name);
```

### Variables
The `DeleteUserRecord` mutation requires an argument of type `DeleteUserRecordVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:

```typescript
export interface DeleteUserRecordVariables {
  id: string;
}
```
### Return Type
Recall that executing the `DeleteUserRecord` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `DeleteUserRecordData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface DeleteUserRecordData {
  user_delete?: User_Key | null;
}
```
### Using `DeleteUserRecord`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteUserRecord, DeleteUserRecordVariables } from '@dataconnect/generated';

// The `DeleteUserRecord` mutation requires an argument of type `DeleteUserRecordVariables`:
const deleteUserRecordVars: DeleteUserRecordVariables = {
  id: ..., 
};

// Call the `deleteUserRecord()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await deleteUserRecord(deleteUserRecordVars);
// Variables can be defined inline as well.
const { data } = await deleteUserRecord({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await deleteUserRecord(dataConnect, deleteUserRecordVars);

console.log(data.user_delete);

// Or, you can use the `Promise` API.
deleteUserRecord(deleteUserRecordVars).then((response) => {
  const data = response.data;
  console.log(data.user_delete);
});
```

### Using `DeleteUserRecord`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteUserRecordRef, DeleteUserRecordVariables } from '@dataconnect/generated';
...
// Call the `deleteUserRecordRef()` function to get a reference to the mutation.
const ref = deleteUserRecordRef(deleteUserRecordVars);
// Variables can be defined inline as well.
const ref = deleteUserRecordRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteUserRecordRef(dataConnect, deleteUserRecordVars);
...
## DeleteConfiguracion
You can execute the `DeleteConfiguracion` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
deleteConfiguracion(vars: DeleteConfiguracionVariables): MutationPromise<DeleteConfiguracionData, DeleteConfiguracionVariables>;

interface DeleteConfiguracionRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: DeleteConfiguracionVariables): MutationRef<DeleteConfiguracionData, DeleteConfiguracionVariables>;
}
export const deleteConfiguracionRef: DeleteConfiguracionRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
deleteConfiguracion(dc: DataConnect, vars: DeleteConfiguracionVariables): MutationPromise<DeleteConfiguracionData, DeleteConfiguracionVariables>;

interface DeleteConfiguracionRef {
  ...
  (dc: DataConnect, vars: DeleteConfiguracionVariables): MutationRef<DeleteConfiguracionData, DeleteConfiguracionVariables>;
}
export const deleteConfiguracionRef: DeleteConfiguracionRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the deleteConfiguracionRef:
```typescript
const name = deleteConfiguracionRef.operationName;
console.log(name);
```

### Variables
The `DeleteConfiguracion` mutation requires an argument of type `DeleteConfiguracionVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:

```typescript
export interface DeleteConfiguracionVariables {
  id: string;
}
```
### Return Type
Recall that executing the `DeleteConfiguracion` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `DeleteConfiguracionData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface DeleteConfiguracionData {
  configuracion_delete?: Configuracion_Key | null;
}
```
### Using `DeleteConfiguracion`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteConfiguracion, DeleteConfiguracionVariables } from '@dataconnect/generated';

// The `DeleteConfiguracion` mutation requires an argument of type `DeleteConfiguracionVariables`:
const deleteConfiguracionVars: DeleteConfiguracionVariables = {
  id: ..., 
};

// Call the `deleteConfiguracion()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await deleteConfiguracion(deleteConfiguracionVars);
// Variables can be defined inline as well.
const { data } = await deleteConfiguracion({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await deleteConfiguracion(dataConnect, deleteConfiguracionVars);

console.log(data.configuracion_delete);

// Or, you can use the `Promise` API.
deleteConfiguracion(deleteConfiguracionVars).then((response) => {
  const data = response.data;
  console.log(data.configuracion_delete);
});
```

### Using `DeleteConfiguracion`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteConfiguracionRef, DeleteConfiguracionVariables } from '@dataconnect/generated';
...
// Call the `deleteConfiguracionRef()` function to get a reference to the mutation.
const ref = deleteConfiguracionRef(deleteConfiguracionVars);
// Variables can be defined inline as well.
const ref = deleteConfiguracionRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteConfiguracionRef(dataConnect, deleteConfiguracionVars);
...
## DeletePaquete
You can execute the `DeletePaquete` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
deletePaquete(vars: DeletePaqueteVariables): MutationPromise<DeletePaqueteData, DeletePaqueteVariables>;

interface DeletePaqueteRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: DeletePaqueteVariables): MutationRef<DeletePaqueteData, DeletePaqueteVariables>;
}
export const deletePaqueteRef: DeletePaqueteRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
deletePaquete(dc: DataConnect, vars: DeletePaqueteVariables): MutationPromise<DeletePaqueteData, DeletePaqueteVariables>;

interface DeletePaqueteRef {
  ...
  (dc: DataConnect, vars: DeletePaqueteVariables): MutationRef<DeletePaqueteData, DeletePaqueteVariables>;
}
export const deletePaqueteRef: DeletePaqueteRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the deletePaqueteRef:
```typescript
const name = deletePaqueteRef.operationName;
console.log(name);
```

### Variables
The `DeletePaquete` mutation requires an argument of type `DeletePaqueteVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:

```typescript
export interface DeletePaqueteVariables {
  id: UUIDString;
}
```
### Return Type
Recall that executing the `DeletePaquete` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `DeletePaqueteData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface DeletePaqueteData {
  paquete_delete?: Paquete_Key | null;
}
```
### Using `DeletePaquete`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deletePaquete, DeletePaqueteVariables } from '@dataconnect/generated';

// The `DeletePaquete` mutation requires an argument of type `DeletePaqueteVariables`:
const deletePaqueteVars: DeletePaqueteVariables = {
  id: ..., 
};

// Call the `deletePaquete()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await deletePaquete(deletePaqueteVars);
// Variables can be defined inline as well.
const { data } = await deletePaquete({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await deletePaquete(dataConnect, deletePaqueteVars);

console.log(data.paquete_delete);

// Or, you can use the `Promise` API.
deletePaquete(deletePaqueteVars).then((response) => {
  const data = response.data;
  console.log(data.paquete_delete);
});
```

### Using `DeletePaquete`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deletePaqueteRef, DeletePaqueteVariables } from '@dataconnect/generated';
...
// Call the `deletePaqueteRef()` function to get a reference to the mutation.
const ref = deletePaqueteRef(deletePaqueteVars);
// Variables can be defined inline as well.
const ref = deletePaqueteRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deletePaqueteRef(dataConnect, deletePaqueteVars);
...
You can execute the `DeleteMovimientoInventario` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
deleteMovimientoInventario(vars: DeleteMovimientoInventarioVariables): MutationPromise<DeleteMovimientoInventarioData, DeleteMovimientoInventarioVariables>;

interface DeleteMovimientoInventarioRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: DeleteMovimientoInventarioVariables): MutationRef<DeleteMovimientoInventarioData, DeleteMovimientoInventarioVariables>;
}
export const deleteMovimientoInventarioRef: DeleteMovimientoInventarioRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
deleteMovimientoInventario(dc: DataConnect, vars: DeleteMovimientoInventarioVariables): MutationPromise<DeleteMovimientoInventarioData, DeleteMovimientoInventarioVariables>;

interface DeleteMovimientoInventarioRef {
  ...
  (dc: DataConnect, vars: DeleteMovimientoInventarioVariables): MutationRef<DeleteMovimientoInventarioData, DeleteMovimientoInventarioVariables>;
}
export const deleteMovimientoInventarioRef: DeleteMovimientoInventarioRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the deleteMovimientoInventarioRef:
```typescript
const name = deleteMovimientoInventarioRef.operationName;
console.log(name);
```

### Variables
The `DeleteMovimientoInventario` mutation requires an argument of type `DeleteMovimientoInventarioVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:

```typescript
export interface DeleteMovimientoInventarioVariables {
  id: UUIDString;
}
```
### Return Type
Recall that executing the `DeleteMovimientoInventario` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `DeleteMovimientoInventarioData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface DeleteMovimientoInventarioData {
  movimientoInventario_delete?: MovimientoInventario_Key | null;
}
```
### Using `DeleteMovimientoInventario`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteMovimientoInventario, DeleteMovimientoInventarioVariables } from '@dataconnect/generated';

// The `DeleteMovimientoInventario` mutation requires an argument of type `DeleteMovimientoInventarioVariables`:
const deleteMovimientoInventarioVars: DeleteMovimientoInventarioVariables = {
  id: ..., 
};

// Call the `deleteMovimientoInventario()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await deleteMovimientoInventario(deleteMovimientoInventarioVars);
// Variables can be defined inline as well.
const { data } = await deleteMovimientoInventario({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await deleteMovimientoInventario(dataConnect, deleteMovimientoInventarioVars);

console.log(data.movimientoInventario_delete);

// Or, you can use the `Promise` API.
deleteMovimientoInventario(deleteMovimientoInventarioVars).then((response) => {
  const data = response.data;
  console.log(data.movimientoInventario_delete);
});
```

### Using `DeleteMovimientoInventario`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteMovimientoInventarioRef, DeleteMovimientoInventarioVariables } from '@dataconnect/generated';
...
// Call the `deleteMovimientoInventarioRef()` function to get a reference to the mutation.
const ref = deleteMovimientoInventarioRef(deleteMovimientoInventarioVars);
// Variables can be defined inline as well.
const ref = deleteMovimientoInventarioRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteMovimientoInventarioRef(dataConnect, deleteMovimientoInventarioVars);
...
## DeleteDescuento
You can execute the `DeleteDescuento` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
deleteDescuento(vars: DeleteDescuentoVariables): MutationPromise<DeleteDescuentoData, DeleteDescuentoVariables>;

interface DeleteDescuentoRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: DeleteDescuentoVariables): MutationRef<DeleteDescuentoData, DeleteDescuentoVariables>;
}
export const deleteDescuentoRef: DeleteDescuentoRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
deleteDescuento(dc: DataConnect, vars: DeleteDescuentoVariables): MutationPromise<DeleteDescuentoData, DeleteDescuentoVariables>;

interface DeleteDescuentoRef {
  ...
  (dc: DataConnect, vars: DeleteDescuentoVariables): MutationRef<DeleteDescuentoData, DeleteDescuentoVariables>;
}
export const deleteDescuentoRef: DeleteDescuentoRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the deleteDescuentoRef:
```typescript
const name = deleteDescuentoRef.operationName;
console.log(name);
```

### Variables
The `DeleteDescuento` mutation requires an argument of type `DeleteDescuentoVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:

```typescript
export interface DeleteDescuentoVariables {
  id: UUIDString;
}
```
### Return Type
Recall that executing the `DeleteDescuento` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `DeleteDescuentoData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface DeleteDescuentoData {
  descuento_delete?: Descuento_Key | null;
}
```
### Using `DeleteDescuento`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteDescuento, DeleteDescuentoVariables } from '@dataconnect/generated';

// The `DeleteDescuento` mutation requires an argument of type `DeleteDescuentoVariables`:
const deleteDescuentoVars: DeleteDescuentoVariables = {
  id: ..., 
};

// Call the `deleteDescuento()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await deleteDescuento(deleteDescuentoVars);
// Variables can be defined inline as well.
const { data } = await deleteDescuento({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await deleteDescuento(dataConnect, deleteDescuentoVars);

console.log(data.descuento_delete);

// Or, you can use the `Promise` API.
deleteDescuento(deleteDescuentoVars).then((response) => {
  const data = response.data;
  console.log(data.descuento_delete);
});
```

### Using `DeleteDescuento`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteDescuentoRef, DeleteDescuentoVariables } from '@dataconnect/generated';
...
// Call the `deleteDescuentoRef()` function to get a reference to the mutation.
const ref = deleteDescuentoRef(deleteDescuentoVars);
// Variables can be defined inline as well.
const ref = deleteDescuentoRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteDescuentoRef(dataConnect, deleteDescuentoVars);
...
## DeleteMesaReserva
You can execute the `DeleteMesaReserva` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
deleteMesaReserva(vars: DeleteMesaReservaVariables): MutationPromise<DeleteMesaReservaData, DeleteMesaReservaVariables>;

interface DeleteMesaReservaRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: DeleteMesaReservaVariables): MutationRef<DeleteMesaReservaData, DeleteMesaReservaVariables>;
}
export const deleteMesaReservaRef: DeleteMesaReservaRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
deleteMesaReserva(dc: DataConnect, vars: DeleteMesaReservaVariables): MutationPromise<DeleteMesaReservaData, DeleteMesaReservaVariables>;

interface DeleteMesaReservaRef {
  ...
  (dc: DataConnect, vars: DeleteMesaReservaVariables): MutationRef<DeleteMesaReservaData, DeleteMesaReservaVariables>;
}
export const deleteMesaReservaRef: DeleteMesaReservaRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the deleteMesaReservaRef:
```typescript
const name = deleteMesaReservaRef.operationName;
console.log(name);
```

### Variables
The `DeleteMesaReserva` mutation requires an argument of type `DeleteMesaReservaVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:

```typescript
export interface DeleteMesaReservaVariables {
  id: UUIDString;
}
```
### Return Type
Recall that executing the `DeleteMesaReserva` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `DeleteMesaReservaData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface DeleteMesaReservaData {
  mesaReserva_delete?: MesaReserva_Key | null;
}
```
### Using `DeleteMesaReserva`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteMesaReserva, DeleteMesaReservaVariables } from '@dataconnect/generated';

// The `DeleteMesaReserva` mutation requires an argument of type `DeleteMesaReservaVariables`:
const deleteMesaReservaVars: DeleteMesaReservaVariables = {
  id: ..., 
};

// Call the `deleteMesaReserva()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await deleteMesaReserva(deleteMesaReservaVars);
// Variables can be defined inline as well.
const { data } = await deleteMesaReserva({ id: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await deleteMesaReserva(dataConnect, deleteMesaReservaVars);

console.log(data.mesaReserva_delete);

// Or, you can use the `Promise` API.
deleteMesaReserva(deleteMesaReservaVars).then((response) => {
  const data = response.data;
  console.log(data.mesaReserva_delete);
});
```

### Using `DeleteMesaReserva`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteMesaReservaRef, DeleteMesaReservaVariables } from '@dataconnect/generated';
...
// Call the `deleteMesaReservaRef()` function to get a reference to the mutation.
const ref = deleteMesaReservaRef(deleteMesaReservaVars);
// Variables can be defined inline as well.
const ref = deleteMesaReservaRef({ id: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteMesaReservaRef(dataConnect, deleteMesaReservaVars);
...
## UpsertConfiguracion
You can execute the `UpsertConfiguracion` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
upsertConfiguracion(vars: UpsertConfiguracionVariables): MutationPromise<UpsertConfiguracionData, UpsertConfiguracionVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
upsertConfiguracion(dc: DataConnect, vars: UpsertConfiguracionVariables): MutationPromise<UpsertConfiguracionData, UpsertConfiguracionVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the upsertConfiguracionRef:
```typescript
const name = upsertConfiguracionRef.operationName;
console.log(name);
```

### Variables
The `UpsertConfiguracion` mutation requires an argument of type `UpsertConfiguracionVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `UpsertConfiguracion` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `UpsertConfiguracionData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface UpsertConfiguracionData {
  configuracion_upsert: Configuracion_Key;
}
```
### Using `UpsertConfiguracion`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, upsertConfiguracion, UpsertConfiguracionVariables } from '@dataconnect/generated';

// The `UpsertConfiguracion` mutation requires an argument of type `UpsertConfiguracionVariables`:
const upsertConfiguracionVars: UpsertConfiguracionVariables = {
  id: ..., 
  precioAdulto: ..., 
  precioNino: ..., 
  precioMayor: ..., 
...
// Call the `upsertConfiguracion()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await upsertConfiguracion(upsertConfiguracionVars);
// Variables can be defined inline as well.
const { data } = await upsertConfiguracion({ id: ..., precioAdulto: ..., precioNino: ..., precioMayor: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await upsertConfiguracion(dataConnect, upsertConfiguracionVars);

console.log(data.configuracion_upsert);

// Or, you can use the `Promise` API.
upsertConfiguracion(upsertConfiguracionVars).then((response) => {
  const data = response.data;
  console.log(data.configuracion_upsert);
});
```

### Using `UpsertConfiguracion`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, upsertConfiguracionRef, UpsertConfiguracionVariables } from '@dataconnect/generated';
...
// Call the `upsertConfiguracionRef()` function to get a reference to the mutation.
const ref = upsertConfiguracionRef(upsertConfiguracionVars);
// Variables can be defined inline as well.
const ref = upsertConfiguracionRef({ id: ..., precioAdulto: ..., precioNino: ..., precioMayor: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = upsertConfiguracionRef(dataConnect, upsertConfiguracionVars);
...
## CreateDescuento
You can execute the `CreateDescuento` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
createDescuento(vars: CreateDescuentoVariables): MutationPromise<CreateDescuentoData, CreateDescuentoVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
createDescuento(dc: DataConnect, vars: CreateDescuentoVariables): MutationPromise<CreateDescuentoData, CreateDescuentoVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the createDescuentoRef:
```typescript
const name = createDescuentoRef.operationName;
console.log(name);
```

### Variables
The `CreateDescuento` mutation requires an argument of type `CreateDescuentoVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `CreateDescuento` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `CreateDescuentoData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface CreateDescuentoData {
  descuento_insert: Descuento_Key;
}
```
### Using `CreateDescuento`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createDescuento, CreateDescuentoVariables } from '@dataconnect/generated';

// The `CreateDescuento` mutation requires an argument of type `CreateDescuentoVariables`:
const createDescuentoVars: CreateDescuentoVariables = {
  codigo: ..., 
  descuento: ..., 
  tipo: ..., 
  usosRestantes: ..., 
...
// Call the `createDescuento()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await createDescuento(createDescuentoVars);
// Variables can be defined inline as well.
const { data } = await createDescuento({ codigo: ..., descuento: ..., tipo: ..., usosRestantes: ..., activo: ..., reglasJson: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await createDescuento(dataConnect, createDescuentoVars);

console.log(data.descuento_insert);

// Or, you can use the `Promise` API.
createDescuento(createDescuentoVars).then((response) => {
  const data = response.data;
  console.log(data.descuento_insert);
});
```

### Using `CreateDescuento`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, createDescuentoRef, CreateDescuentoVariables } from '@dataconnect/generated';
...
// Call the `createDescuentoRef()` function to get a reference to the mutation.
const ref = createDescuentoRef(createDescuentoVars);
// Variables can be defined inline as well.
const ref = createDescuentoRef({ codigo: ..., descuento: ..., tipo: ..., usosRestantes: ..., activo: ..., reglasJson: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = createDescuentoRef(dataConnect, createDescuentoVars);
...
## UpdateDescuento
You can execute the `UpdateDescuento` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
updateDescuento(vars: UpdateDescuentoVariables): MutationPromise<UpdateDescuentoData, UpdateDescuentoVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
updateDescuento(dc: DataConnect, vars: UpdateDescuentoVariables): MutationPromise<UpdateDescuentoData, UpdateDescuentoVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the updateDescuentoRef:
```typescript
const name = updateDescuentoRef.operationName;
console.log(name);
```

### Variables
The `UpdateDescuento` mutation requires an argument of type `UpdateDescuentoVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `UpdateDescuento` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `UpdateDescuentoData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface UpdateDescuentoData {
  descuento_update?: Descuento_Key | null;
}
```
### Using `UpdateDescuento`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateDescuento, UpdateDescuentoVariables } from '@dataconnect/generated';

// The `UpdateDescuento` mutation requires an argument of type `UpdateDescuentoVariables`:
const updateDescuentoVars: UpdateDescuentoVariables = {
  id: ..., 
  codigo: ..., 
  descuento: ..., 
  tipo: ..., 
...
// Call the `updateDescuento()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await updateDescuento(updateDescuentoVars);
// Variables can be defined inline as well.
const { data } = await updateDescuento({ id: ..., codigo: ..., descuento: ..., tipo: ..., usosRestantes: ..., activo: ..., reglasJson: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await updateDescuento(dataConnect, updateDescuentoVars);

console.log(data.descuento_update);

// Or, you can use the `Promise` API.
updateDescuento(updateDescuentoVars).then((response) => {
  const data = response.data;
  console.log(data.descuento_update);
});
```

### Using `UpdateDescuento`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateDescuentoRef, UpdateDescuentoVariables } from '@dataconnect/generated';
...
// Call the `updateDescuentoRef()` function to get a reference to the mutation.
const ref = updateDescuentoRef(updateDescuentoVars);
// Variables can be defined inline as well.
const ref = updateDescuentoRef({ id: ..., codigo: ..., descuento: ..., tipo: ..., usosRestantes: ..., activo: ..., reglasJson: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = updateDescuentoRef(dataConnect, updateDescuentoVars);
...
## ConsumeDescuento
You can execute the `ConsumeDescuento` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
consumeDescuento(vars: ConsumeDescuentoVariables): MutationPromise<ConsumeDescuentoData, ConsumeDescuentoVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
consumeDescuento(dc: DataConnect, vars: ConsumeDescuentoVariables): MutationPromise<ConsumeDescuentoData, ConsumeDescuentoVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the consumeDescuentoRef:
```typescript
const name = consumeDescuentoRef.operationName;
console.log(name);
```

### Variables
The `ConsumeDescuento` mutation requires an argument of type `ConsumeDescuentoVariables`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `ConsumeDescuento` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `ConsumeDescuentoData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface ConsumeDescuentoData {
  descuento_update?: Descuento_Key | null;
}
```
### Using `ConsumeDescuento`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, consumeDescuento, ConsumeDescuentoVariables } from '@dataconnect/generated';

// The `ConsumeDescuento` mutation requires an argument of type `ConsumeDescuentoVariables`:
const consumeDescuentoVars: ConsumeDescuentoVariables = {
  id: ..., 
  usosRestantesNext: ..., 
};

// Call the `consumeDescuento()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await consumeDescuento(consumeDescuentoVars);
// Variables can be defined inline as well.
const { data } = await consumeDescuento({ id: ..., usosRestantesNext: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await consumeDescuento(dataConnect, consumeDescuentoVars);

console.log(data.descuento_update);

// Or, you can use the `Promise` API.
consumeDescuento(consumeDescuentoVars).then((response) => {
  const data = response.data;
  console.log(data.descuento_update);
});
```

### Using `ConsumeDescuento`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, consumeDescuentoRef, ConsumeDescuentoVariables } from '@dataconnect/generated';
...
// Call the `consumeDescuentoRef()` function to get a reference to the mutation.
const ref = consumeDescuentoRef(consumeDescuentoVars);
// Variables can be defined inline as well.
const ref = consumeDescuentoRef({ id: ..., usosRestantesNext: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = consumeDescuentoRef(dataConnect, consumeDescuentoVars);
